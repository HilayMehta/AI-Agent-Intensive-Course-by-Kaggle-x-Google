...
1. We’ve expanded capacity for the 5-Day AI Agents Intensive, so everyone interested can join the course. No more 429s!

2. Find the complete list of scheduled livestreams and past recordings here.

3. We also have a troubleshooting guide for the codelabs. Be sure to check there for solutions to common problems.

4. Tomorrow’s livestream will be hosted by Kanchana Patlolla and Anant Nawalgaria at 11 AM PT / 8 PM CET / 12:30 AM IST (next day). They will be joined by codelabs author Sita Lakshmi Sangameswaran, along with guests from Google: Wafae Bakkali, Turan Bulmus and Sian Gooding, and external guest Jiwei Liu from NVIDIA.

5. Assignments are provided for your learning, so assignment submissions are not required, and you can complete them at your own pace.

6. We want this community to be positive and supportive. Please follow Kaggle’s community guidelines found here.
